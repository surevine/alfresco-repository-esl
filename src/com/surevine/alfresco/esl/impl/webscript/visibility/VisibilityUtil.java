...
public class VisibilityUtil {
    ...
    private boolean processLogic(final RMCaveatConfigService caveatConfig, final String constraintSpecName, final String[] constraintSpecValues, final String authorityName, final boolean andLogic) {
     ...
     * 
     * @param configService
     *            Provided by the caller from spring
     * @param constraintName
     *            ShortName of the constraint to return groups for. Must refer to an EnhancedSecurityConstraint, not a regular RMListOfValuesConstraint
     * @param type
     *            If not null, only return groups which are of this type. This is case sensitive
