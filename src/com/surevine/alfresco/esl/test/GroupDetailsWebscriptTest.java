...
/**
 * This test feels a little like cheating but when I think about it it seems to work out - the model stuff is not within scope of a unit, all the lower level stuff is tested elsewhere, which just leaves the json formatting, which doesn't vary with input. So here we are
 * 
 * @author simonw
 * 
 */
