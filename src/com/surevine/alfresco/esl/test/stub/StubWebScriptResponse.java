...
/**
 * A webscript response we can use for testing purposes. Currently, only the getWriter() mehtod is functional. This writes to a local String so the data written can be retrieved with a call to getData();
 * 
 * @author simonw
 * 
 */
