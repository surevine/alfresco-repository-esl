...
/**
 * Version of group details webscript that overrides the section of the code that deals with the data dictionary, which allows us to test without just re-testing the dictionary and with less dependencies
 * 
 * @author simonw
 * 
 */
