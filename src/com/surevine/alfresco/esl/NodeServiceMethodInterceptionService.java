...
/**
 * Describes a service implementing a collection of methods to links NodeRefs to MethodInvocations operating on those NodeRefs
 * 
...
public interface NodeServiceMethodInterceptionService {
    ...
    /**
     * For a given method call, return the collection of NodeRefs used as parameters to that method call that are also marked as protected in the security configuration
     * 
     * @param config
     *            Configuration indicating which, if any, NodeRefs in the method call parameters should be protected
     * @param mi
     *            MethodInvocation object describing an intercepted method call
    ...
    /**
     * For a given Node-level security definition within a ConfigAttributeDefinition, return the index into the protected method's parameters for which that node refers
     * 
     * @param attrVal
     * @return
     */
